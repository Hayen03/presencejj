...
use crate::{cdj::{comptes::{Compte, CompteReg}, groupes::{GroupeID, GroupeReg}, membres::{Contact, Membre}}, data::{BoolJustifie, adresse::Adresse, email::Email, tel::Tel}, ui::{Screen, UIError, UpdateAction, screens::{PageError, TextInputAfter}}};
...
fn membre_to_fields(membre: &Membre, compte: Option<&Compte>, groupes: &[Groupes]) -> HashMap<&'static str, Arc<RwLock<Field>>> {
